...
# Pour chaque ligne, creer un objet Citation
# Creer une methode statique qui va retourner une citation au hasard a partir d'une liste d'objets
# Creer une methode statique pour trier les citations par ordre alphabetique
#   (sans utilisert sort, votre choix d'algo)
# Creer une methode statique pour trier les citations par ordre alphabetique de l'auteur
#   (sans utilisert sort, votre choix d'algo)
# Creer une methode pour compresser chaque citation dans un fichier texte dans le repertoire "tmp"
#   Le nom de fichier doit etre le nom de l'auteur, si existant, ajoute la citation au fichier
# Creer une methode statique pour lire tous les fichiers du repertoire et
